document.addEventListener('DOMContentLoaded', function () {
  ...
  const typewriterText = `Vous considérez l'alternance comme un investissement d'avenir pour votre entreprise.
  ...
  function typeWriter() {
    if (i < typewriterText.length) {
      typewriterElement.innerHTML =
        typewriterText.substring(0, i + 1) + '<span class="typewriter-cursor"></span>';
      i++;
